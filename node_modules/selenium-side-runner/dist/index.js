...
if (_commander.default.proxyType) {
  try {
    ...
    _winston.default.error(e.message);
...
if (_commander.default.outputDirectory) {
  ...
  if (!configuration.outputFormat) {
    ...
    _winston.default.error(`'${format}'is not an output format, allowed values: ${allowedFormats}`);
...
function runProject(project) {
  ...
  _fs.default.writeFileSync(_path.default.join(projectPath, 'package.json'), JSON.stringify(_objectSpread({
